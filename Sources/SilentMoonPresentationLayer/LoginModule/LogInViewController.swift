...
final class LogInViewController: UIViewController {
    ...
    private lazy var form = AppFactory.scrollableForm()
    ...
    private lazy var titleLabel = AppFactory.titleLabel(AppStrings.welcomeLogInTitle.letters)
    private lazy var dividerLabel = AppFactory.dividerLabel(AppStrings.logInWithEmailDivider.letters)
