...
public final class SignUpViewController: UIViewController {
    ...
    private var (scrollView, contentView) = AppFactory.scrollableForm()
    private lazy var titleLabel = AppFactory.titleLabel(AppStrings.createAccountTitle.letters)
    private lazy var facebookButton = AuthFactory.facebookButton()
    private lazy var googleButton = AuthFactory.googleButton()
    private lazy var dividerLabel = AppFactory.dividerLabel(AppStrings.signUpWithEmailDivider.letters)
