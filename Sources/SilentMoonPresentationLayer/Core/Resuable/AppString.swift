...
enum AppStrings: String {
    ...
    case unknownErrorAlert = "An unknown error occurred."
    case okAlertTitle = "OK"
    case loadingAccessibilityLabel = "Loading"

    case acceptPrivacyPolicyAlert = "Please accept the Privacy Policy to continue."
    case passwordFieldName = "Password "
    case nameFieldName = "Name"
    ...
    case otpSubtitleFormat = "Enter the 6-digit code sent to %@."
    case otpPlaceholder = "6-digit code"
    case verifyButtonTitle = "VERIFY"
    case resendCodeButtonTitle = "Resend code"
    ...
    case noDaysSelectedError = "Please select at least one day."
    case reminderNotFoundToUpdateError = "Reminder to update was not found."
    case reminderNotFoundToDeleteError = "Reminder to delete was not found."
